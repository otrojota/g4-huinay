...
toExport.registerListener = listener => zsListeners.push(listener)
toExport.registerModule = (extension, zModule) => {
    zsModules[extension] = zModule;
    zModule.zExtension = extension;
}
toExport.setInternalErrorMessage = msg => internalErrorMessage = msg
toExport.resolve = function(req, res) {
...
toExport.ZModule = ZModule; // Class
