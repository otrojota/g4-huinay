...
ZVC.registerComponent("DIV", e => (e.getAttribute("data-z-repeat")), ZBootstrapRepeater);
ZVC.registerComponent("UL", e => (e.getAttribute("data-z-repeat")), ZBootstrapRepeater);
ZVC.registerComponent("OL", e => (e.getAttribute("data-z-repeat")), ZBootstrapRepeater);