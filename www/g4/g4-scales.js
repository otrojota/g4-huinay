class ScalesFactory {
    async init(geoserverURL, metadata) {
        this.scaleDefs = [];
        for (let scaleDef of metadata.colorScales || []) {
            if (scaleDef.type == "pg") {
...
class HSLLinearScale extends G4ColorScale {
...
class LinearTransparencyScale extends G4ColorScale {
    get colors() {
...
class PGScale extends G4ColorScale {
    constructor(scaleDef, config) {
...
class NegativePositiveScale extends G4ColorScale {
...
class RangesScale extends G4ColorScale {
    constructor(scaleDef, config) {
        super(scaleDef, config);
...
class RGBDecoderScale extends G4ColorScale {
    getColor(value) {        
...
class RGBADecoderScale extends G4ColorScale {
    getColor(value) {        
